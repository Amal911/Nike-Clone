...
const addButtonListener2 =  function () {
  ...
  const fetchData = async () => {
    ...
    let carousel = document.getElementById("main-carousal");
    ...
    data.forEach((product) => {
      ...
      <a href="/pages/product.html?cat=favourites&id=${product.id}" style="all: unset;">
  ...
  fetchData().then(addButtonListener2);
